...
#}
    ...
    def deploy_fleet(self, fleet_locations):
        ...
        '''
        for k, loc in fleet_locations.items():
            ship_size = SHIP_SIZES[k]
            for r in range(ship_size):
                self.board[loc[0]+r][loc[1]] = k
    ...
    def is_game_over(self):
        ...
        for r in range(size):
            collist: []
            if collist==0 :
                print("All the ships have been sunk")
                return None
        # YOUR CODE HERE
        # Replace None with an appropriate return value
        return None
    ...
    def __str__(self):
       ...
       str_tank = " 1 2 3 4 5 6 7 8 9\n"
       for i in range(10):
           str_tank += str(i)
           for j in range(10):
               str_tank += self.board[i][j]
           if i!= 9:
               str_tank += "\n"
       return  str_tank
...
# fleet = [["Submarine", 0 , 0 , true],["Submarine", 0 , 0 , true],["Submarine", 0 , 0 , true]]
# fleet[2][0]

# fleet = [Ship("Submarine", 0 , 0 , true), Ship("Submarine", 0 , 0 , true), Ship("Submarine", 0 , 0 , true)]
# fleet[2].SIZE
# 
# ship = Ship("Submarine", 0 , 0 , true)
# ship.SIZE = "Submarine"
# ship.ROW = 5
# ship.COL = 8
